    ...
    public class PresentationModelUnitTest
    {
        ...
        public void StartTestMethod()
        {
            ...
            using (ModelImplementation newInstance = new(underneathLayerFixture))
            {
                ...
                newInstance.Start(10, 700.0, 400.0);
        ...
        private class UnderneathLayerFixture : BusinessLogicAbstractAPI
        {
            ...
            // Zaktualizowana sygnatura metody Start (dodano double width, double height)
            public override void Start(int numberOfBalls, double width, double height, Action<IPosition, BusinessLogic.IBall> upperLayerHandler)
            {

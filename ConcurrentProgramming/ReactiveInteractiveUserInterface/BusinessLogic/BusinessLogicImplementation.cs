...
namespace TP.ConcurrentProgramming.BusinessLogic
{
    ...
    #region BusinessLogicAbstractAPI
        ...
        public override void Start(int numberOfBalls, double width, double height, Action<IPosition, IBall> upperLayerHandler)
        {
            ...
            layerBellow.Start(numberOfBalls, width, height, (startingPosition, databall) => upperLayerHandler(new Position(startingPosition.x, startingPosition.y), new Ball(databall)));
        }
